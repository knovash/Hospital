...
public class ToolPatient {
    ...
    public List<Patient> createPatient() throws InvalidNameException {
        ...
        list.add(new Patient(LocalDate.of(1995, 2, 13), "Igor", Human.Gender.MALE, new Address("Belarus", "Minsk", "Berezovaja", 16), new Phone("+375", "29", "883300"), new Credit("Prior", "BYN", new BigDecimal("3000"))));
        ...
        list.add(new Patient(LocalDate.of(1991, 2, 13), "A_lex", Human.Gender.MALE, new Address("Belarus", "Minsk", "Berezovaja", 16), new Phone("+375", "29", "883300"), new Credit("Prior", "BYN", new BigDecimal("500"))));
        list.get(list.size()-1).addTrouble(new Trouble(LocalDate.now(), "Dentist", Spec.DENT));
        list.get(list.size()-1).addTrouble(new Trouble(LocalDate.now(), "Emergency", Spec.EMER));
        list.get(list.size()-1).addTrouble(new Trouble(LocalDate.now(), "Surgeon", Spec.SURG));

        list.add(new Patient(LocalDate.of(1960, 2, 13), "Vera", Human.Gender.FEMALE, new Address("Belarus", "Minsk", "Berezovaja", 16), new Phone("+375", "29", "883300"), new Credit("Prior", "BYN", new BigDecimal("3000"))));
        list.get(list.size()-1).addTrouble(new Trouble(LocalDate.now(), "Cardiologist", Spec.CARD));
        list.get(list.size()-1).addTrouble(new Trouble(LocalDate.now(), "Dentist", Spec.DENT));

        list.add(new Patient(LocalDate.of(1995, 2, 13), "Olga", Human.Gender.FEMALE, new Address("Belarus", "Minsk", "Berezovaja", 16), new Phone("+375", "29", "883300"), new Credit("Prior", "BYN", new BigDecimal("800"))));
